 ...
 * @since 2.0.0
*/
function sugar_calendar_admin_upgrade_page() {
	global $wpdb;
	...
	<div class="wrap">
		...
		<script type="text/javascript"><?php
			...
			if ( $step > $steps ) {
				...
				sugar_calendar_set_upgrade_complete( $action );

			// Redirect to the next step in the upgrader
			} else {
				$url = sugar_calendar_admin_upgrade_page_url( array(
					'upgrade' => $action,
					'step'    => $step,
					'total'   => $total,
					'steps'   => $steps
	...
	// Process the step
	sugar_calendar_process_upgrades();
}
 ...
 * @return string
 */
function sugar_calendar_admin_upgrade_page_url( $args = array() ) {
 ...
 * @since 2.0.0
 */
function sugar_calendar_show_upgrade_notices() {
	...
	if ( ! sugar_calendar_has_upgrade_completed( '20_migration' ) ) {
		printf(
			...
			sugar_calendar_admin_upgrade_page_url( array( 'upgrade' => '20_migration' ) )
		);
	}
}
 ...
 * @return bool
 */
function sugar_calendar_process_upgrades() {
	...
	$func = "sugar_calendar_upgrade_{$step}";
 ...
 */
function sugar_calendar_set_upgrade_complete( $upgrade_action = '' ) {
	...
	$completed_upgrades   = sugar_calendar_get_completed_upgrades();
 ...
 */
function sugar_calendar_has_upgrade_completed( $upgrade_action = '' ) {
 ...
 */
function sugar_calendar_get_completed_upgrades() {
 ...
 * @since 2.0.0
 */
function sugar_calendar_upgrade_20_migration() {
