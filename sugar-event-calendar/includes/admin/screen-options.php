 ...
 * @since 2.0.0
 */
function sugar_calendar_admin_add_screen_options() {
	...
	// Add screen options
	do_action( 'sugar_calendar_add_screen_options' );

	// Custom option output
	add_filter( 'screen_settings', 'sugar_calendar_screen_options', 10, 2 );
}
 ...
 * @return string
 */
function sugar_calendar_screen_options( $settings = '', $screen = false ) {
 ...
 * @since 2.0.0
 */
function sugar_calendar_screen_option_settings() {
	...
	<table class="form-table">
		<tbody>
			...
			<tr valign="top">
				<th scope="row" valign="top">
					<label for="start_of_week"><?php esc_html_e( 'Start of Week' ); ?></label>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row" valign="top">
					<label for="date_format"><?php esc_html_e( 'Date Format' ); ?></label>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row" valign="top">
					<label for="time_format"><?php esc_html_e( 'Time Format' ); ?></label>
				</th>
				<td>
 ...
 * @since 2.0.0
 */
function sugar_calendar_save_screen_options() {
