	...
	protected function extra_tablenav( $which = '' ) {
		...
		elseif ( 'top' === $which ) :
			...
			if ( 'list' === $this->get_mode() ) : ?>
				...
				<input type="number" name="cystart" id="cystart" value="<?php echo (int) $this->get_start_year(); ?>" size="4" step="1" min="0" max="9999">
				...
				<input type="number" name="cy" id="cy" value="<?php echo (int) $this->get_year(); ?>" size="4" step="1" min="0" max="9999">
			...
			// Show single year for non-list modes
				...
				<input type="number" name="cy" id="cy" value="<?php echo (int) $this->year; ?>" size="4" step="1" min="0" max="9999">
