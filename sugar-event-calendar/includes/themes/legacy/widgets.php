...
class sc_events_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'sc_calendar_widget', __('Event Calendar', 'sugar-calendar'), array('description' => __('Displays an events widget', 'sugar-calendar')));
	}
...
?>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('size'); ?>"><?php _e('Calendar Size', 'sugar-calendar'); ?></label>
		</p>
	<p>
...
?>
		...
		<label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Event Category', 'sugar-calendar'); ?></label>
	</p>
	<?php
	}
}
...
class sc_events_list_widget extends WP_Widget
{
	...
	/** constructor */
	public function __construct() {
		parent::__construct('sc_event_list_widget', __('Events List', 'sugar-calendar'), array('description' => __('Displays upcoming/past events in a list view', 'sugar-calendar')));
	}
...
?>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('display'); ?>"><?php _e('All, Past, or Upcoming', 'sugar-calendar'); ?></label>
		</p>
		<p>
			<select class="<?php echo $this->get_field_name('category'); ?>" name="<?php echo $this->get_field_name('category'); ?>" id="<?php echo $this->get_field_id('category'); ?>">
				<option value="0" <?php selected(0, $category); ?>><?php _e('All', 'sugar-calendar'); ?></option>
...
class sc_event_categories_widget extends WP_Widget {
	...
	/** constructor */
	public function __construct() {
		parent::__construct( 'sc_category_widget', __('Event Categories', 'sugar-calendar'), array('description' => __('Display the event categories', 'sugar-calendar')));
	}
...
class sc_event_filter_widget extends WP_Widget {
	...
	/** constructor */
	public function __construct() {
		parent::__construct( 'sc_filter_widget', __('Event Filter', 'sugar-calendar'), array('description' => __('Filtering controls for upcoming and past events display. Use only on /events archive.', 'sugar-calendar')));
	}
